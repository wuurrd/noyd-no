...
Vi bryr oss om miljøet. Vår plattform er designet med bærekraft i tankene, og vi jobber kontinuerlig med å redusere vårt karbonavtrykk, samtidig som vi hjelper deg å gjøre det samme.
    */
    ...
    func_2_text: `Vi står alltid klare til å hjelpe deg med spørsmål eller utfordringer, slik at du aldri føler deg alene når du bruker våre verktøy.`,
    ...
    func_4_text: `Dine data er trygge hos oss. Vi beskytter din informasjon med topp moderne sikkerhetstiltak, slik at du kan ha full tillit til vår plattform.`,
